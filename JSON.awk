...
#
##############################################################
# When a container is creating, at prestart stage,           #
# "/usr/libexec/oci/hooks.d/route-settings" will be executed,#
# and it will use this awk code to parse a json file.        #
##############################################################
#
